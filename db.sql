...
CREATE TABLE methanol_plant_log (
    ...
    -- 园区级数据
    realtime_power_kw NUMERIC(10, 2),
    today_energy_mwh NUMERIC(10, 2),
    unit_energy_consumption NUMERIC(10, 2),
...
COMMENT ON COLUMN methanol_plant_log.realtime_power_kw IS '实时功率 (kW)';
COMMENT ON COLUMN methanol_plant_log.today_energy_mwh IS '今日累计能耗 (MWh)';
